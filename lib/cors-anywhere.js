...
/**
 * Adds Content-Type header to the response headers if it does not already exist.
 *
 * @param headers {object} Response headers
 * @param request {ServerRequest}
 * @param response {ServerRequest} Response object
 */
function withContentType(headers, request) {
  var mime = mimeType.lookup(request.url);
...
function onProxyResponse(proxy, proxyReq, proxyRes, req, res) {
  ...
  withContentType(proxyRes.headers, req);
  return true;
}
